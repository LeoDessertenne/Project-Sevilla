...
<body>
    ...
    <form method="POST" action="gerer_monuments_suite.php">
        ...
        <select name="choices" id="choices">
            <?php
                ...
                $results = $cnx->query("SELECT DISTINCT quartier FROM seville.parcours;");
                while( $ligne = $results->fetch(PDO::FETCH_OBJ)) {
                    $quartier = $ligne->quartier;
                    echo "<option value='$quartier'>$quartier</option>";
                }
            ?>
        </select>
        <br><br>
